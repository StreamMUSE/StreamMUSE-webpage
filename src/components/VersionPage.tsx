      ...
      {version.slug === 'v2' ? (
        <section className="evaluation-invitation" aria-labelledby="evaluation-title">
          <div><span className="evaluation-eyebrow"><Headphones size={17} aria-hidden="true" />LISTENING STUDY</span>
            ...
            <p>Listen to three accompaniment results for one melody and give each a single score for how well it supports the melody, then rank the results overall.</p></div>
