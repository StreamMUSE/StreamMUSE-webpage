...
export const streamMuseVersions: StreamMuseVersion[] = [
  ...
  },
  {
    ...
    status: 'Publicly available',
    statusTone: 'active',
    summary: 'StreamMUSE+ combines BEAT-based music generation with a two-stage prompt and continuation process for more reliable accompaniment as a melody unfolds.',
    focus: 'Towards more stable and interactive real-time piano accompaniment generation.',
    details: [
